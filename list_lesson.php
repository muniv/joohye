...
$list_result = mysql_query('SELECT * FROM lesson');
?>
<!DOCTYPE html>
<html>
    <head>
            ...
            <table>
                ...
                while($row=mysql_fetch_array($list_result)){
					...
					<tr><td><?=htmlspecialchars($row['title'])?></td>
						...
						<td><?=$show?></td>
						<td><?=$download?></td>
						<td><a href="modify_lesson.php?id=<?=$row['id']?>"><img src="modify.png"></a></td>
						<td><form method="POST" action="process_lesson.php?mode=delete_lesson">
                ...
                ?>
                <tr><th><a href="input_lesson.php"><img src="insert.png"></a></th></tr>
                </table>
