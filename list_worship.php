...
$list_result = mysql_query('SELECT * FROM worship');
?>
<!DOCTYPE html>
<html>
    <head>
            ...
            <table>
                ...
                while($row=mysql_fetch_array($list_result)){
					...
					<tr><td><?=htmlspecialchars($row['title'])?></td>
						...
						<td><?=$show?></td>
						<td><?=$download?></td>
						<td><a href="modify_worship.php?id=<?=$row['id']?>"><img src="modify.png"></a></td>
						<td><form method="POST" action="process_worship.php?mode=delete_worship">
                ...
                ?>
                <tr><th><a href="input_worship.php"><img src="insert.png"></a></th></tr>
                </table>
