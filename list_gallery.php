...
$list_result = mysql_query('SELECT * FROM gallery');
?>
<!DOCTYPE html>
<html>
    <head>
            ...
            <table>
                ...
                while($row=mysql_fetch_array($list_result)){
					...
					<tr><td><?=htmlspecialchars($row['title'])?></td>
						...
						<td><?=$show?></td>
						<td><?=$download?></td>
						<td><a href="modify_gallery.php?id=<?=$row['id']?>"><img src="modify.png"></a></td>
						<td><form method="POST" action="process_gallery.php?mode=delete_gallery">
                ...
                ?>
                <tr><th><a href="input_gallery.php"><img src="insert.png"></a></th></tr>
                </table>
