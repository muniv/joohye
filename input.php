...
<html>
	...
	<table border="0" cellspacing="0" cellpadding="0" >
		...
		<tr><td>
        <form action="./process.php?mode=insert_forder" method="POST">
            <p>Korean folder : <input type="text" name="korean_folder"></p>
            <p>English folder : <input type="text" name="english_folder"></p>
            <p>Tagalog folder : <input type="text" name="tagalog_folder"></p>
