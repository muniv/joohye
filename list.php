...
$list_result = mysql_query('SELECT * FROM videolist');
$video1_result = mysql_query('SELECT * FROM video1');
$video2_result = mysql_query('SELECT * FROM video2');
$video3_result = mysql_query('SELECT * FROM video3');
$video4_result = mysql_query('SELECT * FROM video4');
$video5_result = mysql_query('SELECT * FROM video5');
$video6_result = mysql_query('SELECT * FROM video6');
$video7_result = mysql_query('SELECT * FROM video7');
$video8_result = mysql_query('SELECT * FROM video8');
$video9_result = mysql_query('SELECT * FROM video9');
$video10_result = mysql_query('SELECT * FROM video10');
    ...
    <body id="body" background="image3.jpg">
        <div>
            ...
            <table border="0" cellspacing="0" cellpadding="0">
                ...
                <th background="white.png"><a href="modify.php?id=<?=$row['id']?>"><img src="modify.png"></a></th>
                <th background="white.png">    <form method="POST" action="process.php?mode=delete_forder">
                ...
                <tr >
                   ...
                   <?php
					...
					<tr><td><?=htmlspecialchars($row_video['title'])?></td>
						...
						<td ><?=$show?></td>
						<td ><?=$download?></td>
						<td><a href="modify_title<?=$cnt?>.php?id=<?=$row_video['id']?>"><img src="modify.png"></a></td>
						<td><form method="POST" action="process.php?mode=delete_video<?=$cnt?>">
					...
					?>
					<tr><td >video<a href="input_title<?=$cnt?>.php"><img src="insert.png"></a></td><td>&nbsp;</td><td>&nbsp;</td></tr>
					<?php
						}
					...
					?>
					<tr><td>video<a href="input_title<?=$cnt?>.php"><img src="insert.png"></a></td></tr>
					<?php
						}
                   	else if($cnt==3){
                ...
                ?>
                <tr><td colspan=4 align="center">folder<a href="input.php"><img src="insert.png"></a></th></tr>
                </table>
